...
export default function Navigation() {
  const [links, setLinks] = useState([
    { url: "/", name: "inicio", icon1:`
      ...
      ` },
    { url: "/about", name: "Acerca de",icon1:`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M23 21.6479L12 2.35205L1 21.6479H23ZM19.5577 19.6479H4.4423L12 6.39042L19.5577 19.6479Z"></path></svg>
      ` ,
      icon2:`
  ...
  const handleSession = async (e: any) => {
    e.preventDefault();
          ...
          >
            {userLogin && (
              ...
              >
                <button
                  type="submit"
                  className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition-colors capitalize flex gap-2"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"

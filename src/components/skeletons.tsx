  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-800 flex items-center justify-center px-4 sm:px-6 lg:px-8 duration-500">
      <div className="max-w-md w-full animate-pulse">
        <div className="h-[20rem] w-[27rem] bg-white dark:bg-gray-900 rounded-lg shadow-md overflow-hidden duration-500 p-10 flex justify-between items-center flex-col">
          <div className="h-10 w-40 rounded-lg bg-gray-100/45"></div>
          <div className="h-10 w-full rounded-lg bg-gray-100/45"></div>
          <div className="h-10 w-full rounded-lg bg-gray-100/45"></div>
          <div className="h-10 w-full rounded-lg bg-blue-400"></div>
        </div>
      </div>
    </div>
  );

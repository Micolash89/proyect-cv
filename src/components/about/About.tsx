    ...
    <div className="container mx-auto px-4 py-12 ">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
          ...
          >
            <h2 className="text-2xl font-semibold mb-4 dark:text-gray-200">Constructor de CV Estilo Harvard</h2>
        ...
        >
          <h2 className="text-2xl font-semibold mb-6 dark:text-white">Características Principales</h2>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-medium mb-3 dark:text-gray-200">Vista Previa en Tiempo Real</h3>
            ...
            <div>
              <h3 className="text-xl font-medium mb-3 dark:text-gray-200">Asistente IA con Gemini</h3>
              <p className="text-gray-600 dark:text-gray-400">
            ...
            <div>
              <h3 className="text-xl font-medium mb-3 dark:text-gray-200">Formato Harvard Optimizado</h3>
              <p className="text-gray-600 dark:text-gray-400">
            ...
            <div>
              <h3 className="text-xl font-medium mb-3 dark:text-gray-200">Personalización Inteligente</h3>
              <p className="text-gray-600 dark:text-gray-400">
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 dark:text-white">¿Por qué elegir el formato Harvard?</h2>

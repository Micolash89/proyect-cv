      ...
      <div className="bg-white dark:bg-gray-900 shadow-lg rounded-xl overflow-hidden transition-all duration-200">
        <div className="border-b dark:border-gray-700">
          <div className="p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="h-10 w-10 flex items-center justify-center bg-blue-100 dark:bg-blue-900 rounded-lg">
                {getIcon()}
              </div>
            </div>
            ...
            >
              <button
                type="submit"
                className="group flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 
        ...
        <div className="p-6">
          <div className="relative">
            <textarea
              className="w-full min-h-[125px] p-4 bg-gray-50 dark:bg-gray-800 

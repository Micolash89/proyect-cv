      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm">
              Creador de currículum vitae profesional con formato Harvard y
              asistente IA para ayudarte a destacar en tu búsqueda laboral.
            </p>
          </motion.div>
        ...
        >
          <p className="text-center text-sm text-gray-500 dark:text-gray-400">
            © {new Date().getFullYear()} CV Builder. Todos los derechos
            reservados.
          </p>
        </motion.div>
      </div>
